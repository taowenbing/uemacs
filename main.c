...
void usage(int status)
{
  ...
  fputs("   +<n>|-g<n>   start at line <n>\n", stdout);
  fputs("   -v           view mode(read only)\n", stdout);
  fputs("   -s<string>   go to the first occurrence of <string>\n", stdout);
  fputs("   @<rcfile>    execute file <rcfile> instead of .emacsrc\n", stdout);
